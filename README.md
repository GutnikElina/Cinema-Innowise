...
- Валидация всех вводимых значений, обработка ошибок.

***В разработке:*** покупка билетов со стороны пользователей, редактирование своего аккаунта.
...
### Общая структура:
- **Сущности:** 
  - `User` (пользователь): ID, логин, хэшированный пароль, соль используемая для хеширования пароля, роль (администратор/пользователь), дата создания аккаунта.
