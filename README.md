...
| 5. Просмотр купленных билетов и предстоящих сеансов для пользователя | Создание JSP для отображения списка купленных билетов. JSP для отображения доступных сеансов. Реализация сервлетов для обработки запросов и получения данных из базы. | 09.12-10.12 | В процессе     |
